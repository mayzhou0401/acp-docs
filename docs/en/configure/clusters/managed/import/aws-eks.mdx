...
If you need Ingress and storage capabilities, see [Initialize Ingress for AWS EKS](/configure/clusters/managed/cloud-init/network/aws-eks-lb.mdx) and [Initialize storage for AWS EKS](/configure/clusters/managed/cloud-init/storage/aws-eks-storage.mdx).
