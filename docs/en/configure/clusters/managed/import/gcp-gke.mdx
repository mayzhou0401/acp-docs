...
2. The API Server address and CA certificate of the target cluster can be found in the **External endpoints** section.
...
After importing the cluster, if you need to use Ingress and storage-related features, please refer to [Google GKE Ingress Controller Configuration](/configure/clusters/how-to/gke-ingress-controller.mdx) and [Google GKE Storage Configuration](/configure/clusters/how-to/gke-storage.mdx).
