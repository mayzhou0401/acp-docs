...
After importing the cluster, if you need to use Ingress (inbound rules) and storage-related features, please refer to [Azure AKS Cluster Ingress Initialization Configuration](/configure/clusters/managed/cloud-init/network/azure-aks.mdx) and [Azure AKS Cluster Storage Initialization Configuration](/configure/clusters/managed/cloud-init/storage/azure-aks.mdx).
