...
If you need to build an on-premises cluster, please first refer to the [cluster check](/install/prepare/node_preprocessing.mdx#node_checks) to ensure all node configurations meet the requirements. All prerequisites must be satisfied, otherwise cluster deployment may fail.
